// setup views -> imports views and call their functions setup -> save them in an associative array
// setup nav links - addEventListeners to links in nav bar and associates link's id with corresponding view
// show appropriate navigation based on user session (user or guest)
...
function setUserNav() { // sets which buttons are visible depends on the active user/guest
